    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white text-xl">Loading your epic adventure...</p>
        </div>
      </div>
    );
  }
            ...
            {!gameData?.game_active ? (
              <div className="text-center py-8">
                ...
                <button 
                  ...
                  className="bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-white px-8 py-3 rounded-xl font-semibold transition-all transform hover:scale-105"
                >
                  Start New Adventure
                </button>
              </div>
