...
import json
from ...infrastructure.ai.claude.providers.claude_haiku_create_saga import create_saga_with_character
from ...infrastructure.persistence.characters import get_character
from ...infrastructure.persistence.user_data import get_user_record, put_user_record
from ...shared.utils.game_manager import create_new_game
from ...shared.utils.user_record_schema import add_to_active
