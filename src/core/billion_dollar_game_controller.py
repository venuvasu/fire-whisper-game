...
class BillionDollarGameController:
    ...
    def process_player_action(self, player_action: str, ai_response: str = None) -> Dict[str, Any]:
        ...
        engagement_update = self._update_engagement_metrics(
            player_action, story_result, investment_result
        )
    ...
    def _update_engagement_metrics(self, player_action: str, story_result: Dict, investment_result: Dict) -> Dict[str, Any]:
        ...
        # Character growth
        if investment_result.get('progressions_unlocked'):
