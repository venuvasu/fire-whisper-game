...
from ...infrastructure.ai.claude.providers.local_character_creator import create_character_console as create_character_ai
from ...application.controllers.gameplay_handler import GamePerformanceMonitor
import time
