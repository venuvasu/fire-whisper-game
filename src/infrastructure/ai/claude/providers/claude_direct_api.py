...
from .....shared.utils.character_sheet import CharacterSheet
from .....shared.utils.dice_system import DiceRoll, create_roll_choice_prompt
...
try:
    ...
    prompt_file = prompt_dir / "claude_system_prompt_turns.txt"
