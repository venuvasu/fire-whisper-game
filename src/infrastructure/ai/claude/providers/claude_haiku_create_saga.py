...
try:
    ...
    def send_bedrock_amplitude_event(*args, **kwargs):
        ...
        pass
from ....persistence.characters import get_character

# Fix file paths for console
from pathlib import Path

prompt_dir = Path(__file__).parent.parent / "prompts"
start_prompt_file = prompt_dir / "claude_system_prompt_start.txt"
story_arcs_file_path = prompt_dir / "story_arcs.txt"
