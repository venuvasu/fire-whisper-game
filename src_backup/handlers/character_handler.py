...
import uuid
import decimal
from ..ai.providers.claude_haiku_create_character import create_character_with_ai
from ..data.characters import create_character, get_character
from ..data.user_data import get_user_record, put_user_record
from ..utils.user_record_schema import add_character_to_user
...
def 
get_character_handler(event, context):
